  ...
  <div id="pageintro" class="hoc clear"> 
    ...
    <div class="flexslider basicslider">
      <ul class="slides">
        <li>
          <article>
              <h3 style="font-size: 32px"><br><br>Identifying and Ranking Prevalent News Topics Using Social Media Factors<br></h3>
...
<div class="wrapper row5">
  <div id="copyright" class="hoc clear"> 
    <!-- ################################################################################################ -->
    <p class="fl_left">Copyright<a href="#">Domain Name</a></p>
